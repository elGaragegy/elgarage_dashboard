...
export default function CarsPage() {
  ...
  const filters = useMemo<CarFilters>(() => {
    ...
    return f;
  }, [activeTab, statusFilter, debouncedSearch, currentPage, debouncedMinPrice, debouncedMaxPrice, debouncedMinYear, debouncedMaxYear, debouncedMinMileage, debouncedMaxMileage]);
